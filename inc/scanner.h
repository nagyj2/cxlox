...
typedef enum {
	...
	TOKEN_QUESTION, TOKEN_QUESTION_DOT, TOKEN_COLON,

	// One or two char tokens
	TOKEN_BANG, TOKEN_BANG_EQUAL,
	TOKEN_EQUAL, TOKEN_EQUAL_EQUAL, TOKEN_EQUAL_GREATER,
	TOKEN_GREATER, TOKEN_GREATER_EQUAL,
	TOKEN_LESSER, TOKEN_LESSER_EQUAL, TOKEN_LESSER_MINUS,
	TOKEN_MINUS, TOKEN_MINUS_EQUAL, TOKEN_MINUS_GREATER,
	...
	// Keywords
	TOKEN_AND, TOKEN_BREAK, TOKEN_CASE,
	TOKEN_CLASS, TOKEN_CONTINUE, TOKEN_DEFAULT,
	TOKEN_DEL, TOKEN_ELSE,
	TOKEN_FALSE, TOKEN_FOR, TOKEN_FUN, TOKEN_IF,
	TOKEN_IMPORT,
	TOKEN_LET, TOKEN_NIL, TOKEN_OR, TOKEN_PRINT,
	TOKEN_RETURN, TOKEN_SUPER, TOKEN_SWITCH,
